...
from commands.MoodCommands.MoodPredictionCommand import MoodPredictionCommand
...
class TelegramBot:
    ...
    def __init__(self, token):
        ...
        self.commands = {
            ...
            "Menstrual Cycle Stats": PeriodCommandFactory(),
            "Get Mood Prediction for Today": MoodPredictionCommand(),
        }
